"""
Django settings for root project — Base Settings.
...
# BASE_DIR is now two levels up because we are in root/settings/
BASE_DIR = Path(__file__).resolve().parent.parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = config('SECRET_KEY', default='django-insecure-akl^%j^yi=i*=l907f@*wbt3%#n=p4*t)oc-d%kr+^bq^we)pm')
